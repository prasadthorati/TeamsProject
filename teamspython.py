...
# The editor starts empty; "Hi Everyone, Write your message here..." is shown
# as a light-gray placeholder (see EDITOR_PLACEHOLDER + CSS below) that
# disappears the moment the person clicks and starts typing - nothing to
# select and delete first.
DEFAULT_MESSAGE_HTML = ""
EDITOR_PLACEHOLDER = "Hi Everyone, Write your message here..."
    ...
    <script>
        ...
        function setupPasteHandler() {
            ...
            editor.addEventListener('input', function () {
                var onlyEmptyMarkup = editor.innerText.trim() === '' && editor.querySelectorAll('img,table').length === 0;
                if (onlyEmptyMarkup) {
                    editor.innerHTML = ''; // let the CSS placeholder show again
                }
            });
        }
...
<div class="page">
    ...
    <div class="box">
        ...
        <form method="post" action="/send">
            ...
            <div id="message_editor" contenteditable="true" data-placeholder="{{ editor_placeholder }}">{{ form_state.message_html|safe }}</div>
